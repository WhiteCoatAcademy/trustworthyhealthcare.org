        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    $quizResultsCopy.append('<p><button class="btn ' + tryAgainClass + '" href="#">' + plugin.config.tryAgainText + '</button></p>');
                }
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<button href="#" class="btn ' + backToQuestionClass + '">' + plugin.config.backButtonText + '</button>');
                        }
                        ...
                        if (!plugin.config.perQuestionResponseMessaging) {
                            questionHTML.append('<button href="#" class="btn ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + nextText + '</button>');
                        } else {
                            questionHTML.append('<button href="#" class="btn ' + nextQuestionClass + '">' + nextText + '</button>');
                            questionHTML.append('<button href="#" class="btn ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</button>');
                        }
            ...
            checkAnswer: function(checkButton, options) {
                ...
                if (plugin.config.preventUnanswered && selectedAnswers.length === 0) {
                    console.log(plugin.config.preventUnansweredText);
                    return false;
                }
